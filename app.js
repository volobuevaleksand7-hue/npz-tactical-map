...
(function () {
  ...
  function srcHtml(u,label){
    ...
    return '<div class="pp-src pp-src--off">🔒 <a href="'+safeUrl(u)+'" target="_blank" rel="noopener">'+esc(srcHost(u))+' — недоступно из РФ</a></div>'+
      '<div class="pp-vpn"><div class="pp-vpn-h"><span class="pp-vpn-ic"><svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 2.6 20 5.6 V11 c0 5-3.4 8-8 10.4 C8.4 19 4 16 4 11 V5.6 Z"/><circle cx="12" cy="10.4" r="1.7"/><path d="M12 12.1 V14.8"/></svg></span><div class="pp-vpn-t"><span class="pp-vpn-tag">доступ через VPN</span><b>Источник заблокирован в РФ</b><div class="pp-vpn-b">Открыть можно через VPN — бесплатный доступ на 5 дней, подключение за 3 минуты в Telegram-боте</div></div></div>'+
      '<a class="pp-vpn-btn" href="https://t.me/rknoff_bot?start=ref-609952529" target="_blank" rel="noopener nofollow sponsored" onclick="try{ym(110490245,&#39;reachGoal&#39;,&#39;vpn_click&#39;)}catch(e){}">Подключить бесплатно на 5 дней →</a></div>';
  }
