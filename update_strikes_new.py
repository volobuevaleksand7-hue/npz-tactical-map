...
def is_strike_message(text):
    ...
    patterns = [
        ...
        r'(?i)(\u0413\u0423\u0420|\u0413\u0435\u043d\u0448\u0442\u0430\u0412\u0421\u0423|\u0423\u043a\u0440\u0430\u0438\u043d\u0441\u043a\u0438\u0435 \u0421\u0438\u043b\u044b).*?(\u0443\u0434\u0430\u0440|\u0443\u0434\u0430\u0440[ья]|\u0443\u0434\u0430\u0440[оу]|\u0443\u0434\u0430\u0440[а-я]*|\u0443\u0434\u0430\u0440\u0443\u0434\u0430\u0440)',
        r'(?i)(\u0434\u0440\u043e\u043d[аы]?|\u0411\u0435\u0441\u043f\u0438\u043b\u043e\u0442\u043d\u0438\u043a).*?\u0443\u0434\u0430\u0440',
        r'(?i)(\u043f\u0430\u0440\u0438\u043b\u0435\u0442|\u043f\u0430\u0440\u0438\u043b\u0435\u0442\u0438|\u0432\u0437\u0440\u0438\u0432|\u043f\u043e\u0436\u0430\u0440).*?(\u043d\u0435\u0444\u0442|\u0413\u0421\u041c|\u0437\u0430\u0432\u043e\u0434|\u0434\u0435\u043f\u043e)'
    ]
    for pat in patterns:
...
def extract_details(text, dt):
    ...
    lon = None
    # Type
    typ = 'drone' if re.search(r'(?i)(\u0434\u0440\u043e\u043d\u044b|\u0411\u041f\u041b|\u0431\u0435\u0441\u043f\u0438\u043b\u043e\u043b\u0438\u0442\u043d\u0438\u043a)', text) else 'unknown'
    # Count - unknown
    count = None
    ...
    # Confidence
    confidence = 'reported'
    if re.search(r'(?i)(\u043f\u043e\u0434\u0442\u0432\u0435\u0440\u0436\u0435\u043d\u043e|\u043f\u043e\u0434\u0442\u0432\u0435\u0440\u0436\u0430\u0435\u0442|\u043f\u043e\u0434\u0442\u0432\u0435\u0440\u0436\u0430\u0435\u0442|\u043e\u0444\u0438\u0446\u0438\u0430\u043b\u043d\u043e|\u0413\u0428\u0421\u0423|\u0413\u0423\u0420)', text):
        confidence = 'confirmed'
    elif re.search(r'(?i)(\u0441\u0443\u043d\u0445f\u043d\u0435\u043f\u043e\u0434\u0442\u0432\u0435\u0440\u0436\u0435\u043d\u043d\u043e|\u0432\u043e\u0437\u043c\u043e\u0436\u043d\u043e|\u043f\u043e \u0434\u0430\u043d\u043d\u044b\u043¶)', text):
        # Note: The above is a rough approximation for "слухи|неподтверждённо|возможно|по данным"
        # We'll use a simpler pattern: just check for the words in Latin? But we need Cyrillic.
        # Let's break: слухи -> \u0441\u043b\u0443\u0445\u0438, неподтверждённо -> \u043d\u0435\u043f\u043e\u0434\u0442\u0432\u0435\u0440\u0436\u0435\u043d\u043d\u043e, возможно -> \u0432\u043e\u0437\u043c\u043e\u0436\u043d\u043e, по данным -> \u043f\u043e \u0434\u0430\u043d\u043d\u043e\u043c
        # We'll write them out.
        pass  # We'll do it properly below
    # Instead of the above, let's write the patterns explicitly:
    if re.search(r'(?i)(\u0441\u043b\u0443\u0445\u0438|\u043d\u0435\u043f\u043e\u0434\u0442\u0432\u0435\u0440\u0436\u0435\u043d\u043d\u043e|\u0432\u043e\u0437\u043c\u043e\u0436\u043d\u043e|\u043f\u043e\s\u0434\u0430\u043d\u043d\u043e\u043c)', text):
        confidence = 'rumored'
    return {
