...
def _match_refinery_id(strike):
    ...
    refinery_keywords = {
        ...
        # 🔴 Дозаполнено 26.08.2026. До этого словарь покрывал 17 заводов из 33, и
        # остальные 16 (102.9 из 338.4 млн т/год — треть мощностей страны) НЕ могли
        # быть сопоставлены удару В ПРИНЦИПЕ: сколько бы по ним ни прилетало, они
        # оставались «operational». Так 25.08 Астраханский ГПЗ (12 млн т/год) остался
        # работающим на 100% после прямого удара, и headline занижал выбытие.
        #
        # Пробовал выводить признаки из названий автоматически — отказался: словарь
        # ищется в target+title+city, а в заголовке «Обломки БПЛА в многоэтажку
        # КРАСНОДАРА, пожар на Афипском НПЗ» одиночное «краснодар» уводит удар с
        # Афипского на Краснодарский НПЗ. Поэтому там, где одно слово совпадает с
        # названием города, ключ ДВУСЛОВНЫЙ — с родовым словом завода.
        "antipinsky": ["антипинск"],
        "saratov": ["саратовский нпз", "саратовский нефтеперераб"],
        "orsk": ["орский нпз", "орский нефтеперераб"],
        "afipsky": ["афипск"],
        "salavat": ["салават"],
        "ilsky": ["ильский"],
        "slavyansk": ["славянск эко", "славянский нпз"],
        "novoshakhtinsk": ["новошахтинск", "нзнп"],
        "krasnodar-rn": ["краснодарский нпз", "краснодарэконефт"],
        "khabarovsk": ["хабаровский нпз", "хабаровский нефтеперераб"],
        "ukhta": ["ухтинский"],
        "astrakhan-gpz": ["астраханский гпз", "астраханский газоперераб"],
        "mariel": ["марийский нпз", "марийский нефтеперераб"],
        "yaya": ["яйский", "нефтехимсервис"],
        "surgut-zsk": ["сургутский зск", "сургутский завод по стабилизации"],
        "ns-oil": ["ns-oil", "новоспасск"],
    }
