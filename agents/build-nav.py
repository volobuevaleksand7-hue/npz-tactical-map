...
HUB = {
    ...
    "/rabotayut-li-npz-rossii": ("Какие НПЗ работают, а какие стоят", "Статус каждого из 33 НПЗ России на сегодня: работает, ограничен или остановлен — сколько дней в текущем режиме, оценка загрузки и источник. Официальных дат перезапуска нет — страница их не выдумывает"),
}
