...
# 🔴 Порядок полигонов значим: возвращаем ПЕРВЫЙ совпавший. «Севастополь» лежит внутри грубого
# полигона «Республика Крым», поэтому в crimea-regions.geojson он идёт первым — иначе город
# снова растворится в республике и его статус не покрасит ни одной станции.
