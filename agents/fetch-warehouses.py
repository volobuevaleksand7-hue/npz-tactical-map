...
OZON = [
    ...
    # 24.08.2026: РФЦ Ozon был представлен на карте 21 объектом против 42 у WB — не фильтром
    # рендера (он одинаков для обеих сетей), а неполнотой этого справочника. Ниже — крупные
    # РФЦ по регионам, которых тут не хватало; адреса — открытые агрегаторы поставок для
    # селлеров (cdek-busines.ru, ff.cdek.ru), сверены Nominatim на попадание в свой регион.
    ("Ростов-на-Дону", "Ростовская область", "хутор Ленина, Аксайский район, Ростовская область"),
    ("Краснодар", "Краснодарский край", "Краснодар, улица Подсолнечная, 44А"),
    ("Оренбург (Тихая)", "Оренбургская область", "Оренбург, улица Тихая, 15"),
    ("Нижний Новгород (Дзержинск)", "Нижегородская область", "Дзержинск, Игумновское шоссе, 5Г"),
    ("Уфа (Благовещенск)", "Республика Башкортостан", "Благовещенск, улица Социалистическая, 43"),
    ("Красноярск", "Красноярский край", "Красноярск, улица Пограничников, 9"),
    ("Хабаровск", "Хабаровский край", "Хабаровск, улица Донская, 2"),
    ("Тверь (Боровлёво)", "Тверская область", "Боровлёво-2, Калининский район, Тверская область"),
    ("Волгоград (Гумрак)", "Волгоградская область", "Таймырский проезд, 2, Гумрак, Волгоград"),
    ("Невинномысск", "Ставропольский край", "Невинномысск, улица Приозерная, 25"),
    ("Адыгейск", "Республика Адыгея", "хутор Кочкин, Теучежский район, Республика Адыгея"),
    ("Пермь (Култаево)", "Пермский край", "Култаево, Пермский край"),
    ("Махачкала", "Республика Дагестан", "село Коркмаскала, Кумторкалинский район, Республика Дагестан"),
]
...
HIT_NOTES = {
    ...
    ("ozon", "краснодар"): "Пожар на складе Ozon после удара БПЛА, работа приостановлена",
    ("ozon", "махачкала"): "Пожар после удара БПЛА, несколько сотрудников получили лёгкие травмы, работа склада остановлена",
}
