...
CITIES = {
    ...
    "omsk": {
        "slug": "raketnaya-opasnost-omsk",
        "nom": "Омск", "prep": "Омске", "gde": "в Омске",
        "region": "Омская область", "region_prep": "Омской области",
        "emoji": "🚀", "volume": "26 000",
        "ctx": "В Омской области расположены крупные нефтеперерабатывающие и "
               "промышленные объекты, в том числе один из крупнейших НПЗ страны, "
               "поэтому сообщения о воздушной тревоге и работе ПВО по региону "
               "появляются периодически.",
    },
    "cheboksary": {
        "slug": "raketnaya-opasnost-cheboksary",
        "nom": "Чебоксары", "prep": "Чебоксарах", "gde": "в Чебоксарах",
        "region": "Чувашия", "region_prep": "Чувашии",
        "emoji": "🚀", "volume": "23 000",
        "ctx": "Через Поволжье проходят важные промышленные и логистические "
               "маршруты, с которыми связаны периодические сообщения о воздушной "
               "тревоге и ограничениях в работе аэропортов.",
    },
    "moskovskaya-oblast": {
        "slug": "raketnaya-opasnost-moskovskaya-oblast",
        "nom": "Московская область", "prep": "Московской области",
        "gde": "в Московской области",
        "region": "Московская область", "region_prep": "Московской области",
        "emoji": "🚀", "volume": "23 000",
        "ctx": "В Московском регионе сосредоточены крупные промышленные, "
               "энергетические и транспортные объекты, поэтому сообщения о "
               "воздушной тревоге и работе систем ПВО здесь появляются регулярно.",
    },
    "tambovskaya-oblast": {
        "slug": "raketnaya-opasnost-tambovskaya-oblast",
        "nom": "Тамбовская область", "prep": "Тамбовской области",
        "gde": "в Тамбовской области",
        "region": "Тамбовская область", "region_prep": "Тамбовской области",
        "emoji": "🚀", "volume": "18 000",
        "ctx": "В Тамбовской области расположены промышленные и складские "
               "объекты, в том числе крупные логистические центры; после удара "
               "по складу в Котовске 18 июля 2026 года сообщения о воздушной "
               "тревоге по региону отслеживаются особенно внимательно.",
    },
    "penza": {
        "slug": "raketnaya-opasnost-penza",
        "nom": "Пенза", "prep": "Пензе", "gde": "в Пензе",
        "region": "Пензенская область", "region_prep": "Пензенской области",
        "emoji": "🚀", "volume": "23 000",
        "ctx": "В Поволжье расположены промышленные и логистические объекты, "
               "поэтому сообщения о воздушной тревоге и ограничениях в работе "
               "аэропортов по региону появляются периодически.",
    },
    "samara": {
        "slug": "raketnaya-opasnost-samara",
        "nom": "Самара", "prep": "Самаре", "gde": "в Самаре",
        "region": "Самарская область", "region_prep": "Самарской области",
        "emoji": "🚀", "volume": "23 000",
        "ctx": "В Самарской области сосредоточены крупные нефтеперерабатывающие и "
               "промышленные объекты, поэтому сообщения о воздушной тревоге и "
               "работе ПВО по региону появляются периодически.",
    },
    "sverdlovskaya-oblast": {
        "slug": "raketnaya-opasnost-sverdlovskaya-oblast",
        "nom": "Свердловская область", "prep": "Свердловской области",
        "gde": "в Свердловской области",
        "region": "Свердловская область", "region_prep": "Свердловской области",
        "emoji": "🚀", "volume": "20 000",
        "ctx": "В Свердловской области расположены крупные промышленные и "
               "логистические объекты; после ударов БПЛА по логистическому "
               "центру маркетплейса и автостоянке в Екатеринбурге 24–25 июля "
               "2026 года сообщения о воздушной тревоге по региону "
               "отслеживаются особенно внимательно.",
    },
    "rostovskaya-oblast": {
        "slug": "raketnaya-opasnost-rostovskaya-oblast",
        "nom": "Ростовская область", "prep": "Ростовской области",
        "gde": "в Ростовской области",
        "region": "Ростовская область", "region_prep": "Ростовской области",
        "emoji": "🚀", "volume": "22 000",
        "ctx": "В Ростовской области сосредоточены портовая и "
               "железнодорожная инфраструктура, а также топливные объекты — "
               "в том числе Новошахтинский НПЗ (город Новошахтинск, ~100 км "
               "от Ростова-на-Дону, у завода отдельная "
               "<a href=\"/npz/novoshahtinskij-npz\">страница</a>). Удары "
               "БПЛА 25 и 27 июля 2026 года пришлись по самому "
               "Ростову-на-Дону — порту, железнодорожным путям и жилому "
               "сектору города, — поэтому сообщения о воздушной тревоге по "
               "региону отслеживаются особенно внимательно.",
    },
    "kirovskaya-oblast": {
        "slug": "raketnaya-opasnost-kirovskaya-oblast",
        "nom": "Кировская область", "prep": "Кировской области",
        "gde": "в Кировской области",
        "region": "Кировская область", "region_prep": "Кировской области",
        "emoji": "🚀", "volume": "9 000",
        "ctx": "В Кировской области расположены оборонно-промышленные "
               "предприятия, в том числе завод «Авитек» (комплектующие для "
               "систем ПВО и управляемые боеприпасы); после ракетного удара "
               "24 июля, удара БПЛА 25 июля и повторного ракетного удара "
               "27 июля 2026 года по заводу сообщения о воздушной тревоге по "
               "региону отслеживаются особенно внимательно.",
    },
    "tyumenskaya-oblast": {
        "slug": "raketnaya-opasnost-tyumenskaya-oblast",
        "nom": "Тюменская область", "prep": "Тюменской области",
        "gde": "в Тюменской области",
        "region": "Тюменская область", "region_prep": "Тюменской области",
        "emoji": "🚀", "volume": "8 000",
        "ctx": "В Тюменской области расположен Антипинский НПЗ — у завода "
               "отдельная <a href=\"/npz/antipinskij-npz\">страница</a> с "
               "данными о его состоянии. Отражённая атака БПЛА 20 июня и "
               "прямой удар по заводу 25 июля 2026 года — пока единственные "
               "зафиксированные эпизоды по региону, поэтому сообщения о "
               "воздушной тревоге здесь отслеживаются точечно.",
    },
    "ryazanskaya-oblast": {
        "slug": "raketnaya-opasnost-ryazanskaya-oblast",
        "nom": "Рязанская область", "prep": "Рязанской области",
        "gde": "в Рязанской области",
        "region": "Рязанская область", "region_prep": "Рязанской области",
        "emoji": "🚀", "volume": "12 000",
        "ctx": "В Рязанской области расположен Рязанский НПЗ (Роснефть) — у "
               "завода отдельная <a href=\"/npz/ryazanskij-npz\">страница</a> с "
               "данными о его состоянии. В ночь на 29 июля 2026 года сообщается "
               "об ударах БПЛА по заводу и отдельно по логистическому центру "
               "Wildberries в Рязани, поэтому сообщения о воздушной тревоге по "
               "региону отслеживаются особенно внимательно.",
    },
    "belgorod": {
        "slug": "raketnaya-opasnost-belgorod",
        "nom": "Белгород", "prep": "Белгороде", "gde": "в Белгороде",
        "region": "Белгородская область", "region_prep": "Белгородской области",
        "emoji": "🚀", "volume": "40 000",
        "ctx": "Белгородская область — приграничный регион: из-за близости к "
               "зоне боевых действий сигналы воздушной тревоги и ракетной "
               "опасности объявляются здесь чаще, чем в большинстве субъектов "
               "РФ, а сообщения об ударах по объектам энергетики и "
               "транспортной инфраструктуры фиксируются регулярно.",
    },
    "krasnodarskij-kraj": {
        "slug": "raketnaya-opasnost-krasnodarskij-kraj",
        "nom": "Краснодарский край", "prep": "Краснодарском крае",
        "gde": "в Краснодарском крае",
        "region": "Краснодарский край", "region_prep": "Краснодарском крае",
        "emoji": "🚀", "volume": "н/д",
        "ctx": "В Краснодарском крае расположены сразу несколько "
               "нефтеперерабатывающих заводов: Славянский НПЗ (Славянск ЭКО, "
               "5,2 млн т/год) полностью остановлен с 13 сентября 2026 года "
               "после повторной атаки, Туапсинский НПЗ (12 млн т/год) работает "
               "на ~20% мощности, Афипский НПЗ (9 млн т/год) — на ~15%, "
               "Ильский НПЗ (6,6 млн т/год) — на ~40%; в регионе также находится "
               "портовая инфраструктура Чёрного моря (Новороссийск, Тамань) и "
               "военный аэродром в Ейске. С 1 по 20 сентября 2026 года по "
               "региону зафиксировано 22 удара БПЛА, поэтому сообщения о "
               "воздушной тревоге и работе ПВО фиксируются особенно часто.",
    },
    "bryanskaya-oblast": {
        "slug": "raketnaya-opasnost-bryanskaya-oblast",
        "nom": "Брянская область", "prep": "Брянской области",
        "gde": "в Брянской области",
        "region": "Брянская область", "region_prep": "Брянской области",
        "emoji": "🚀", "volume": "н/д",
        "ctx": "Брянская область граничит с Украиной, поэтому сообщения о "
               "воздушной тревоге и ударах БПЛА по гражданским объектам — в "
               "самом Брянске и в приграничных районах (Суземский, Погарский, "
               "Новозыбковский, Стародубский) — фиксируются регулярно; среди "
               "подтверждённых случаев — удар по жилому дому в Советском "
               "районе Брянска 14 августа 2026 года, а удары по региону "
               "продолжаются: последний в архиве данных зафиксирован "
               "21 сентября 2026 года.",
    },
    "voronezhskaya-oblast": {
        "slug": "raketnaya-opasnost-voronezhskaya-oblast",
        "nom": "Воронежская область", "prep": "Воронежской области",
        "gde": "в Воронежской области",
        "region": "Воронежская область", "region_prep": "Воронежской области",
        "emoji": "🚀", "volume": "н/д",
        "ctx": "В Воронежской области расположены оборонно-промышленные и "
               "логистические объекты — в том числе воронежский завод "
               "«Сборка» (микроэлектроника для систем ПВО и РЭБ, удар "
               "22 июня 2026 года) и авиабаза Борисоглебск, где 8 июля "
               "2026 года был уничтожен резервуарный парк ГСМ; последний удар "
               "в архиве данных зафиксирован 10 сентября 2026 года — по "
               "жилому дому в Борисоглебске, — поэтому сообщения о воздушной "
               "тревоге по региону появляются регулярно.",
    },
    "leningradskaya-oblast": {
        "slug": "raketnaya-opasnost-leningradskaya-oblast",
        "nom": "Ленинградская область", "prep": "Ленинградской области",
        "gde": "в Ленинградской области",
        "region": "Ленинградская область", "region_prep": "Ленинградской области",
        "emoji": "🚀", "volume": "н/д",
        "ctx": "В Ленинградской области сосредоточена крупная топливно-"
               "энергетическая и портовая инфраструктура Балтики — "
               "нефтеналивной порт Высоцк, терминалы Усть-Луги и Киришский "
               "НПЗ (Кинеф, 20,1 млн т/год, крупнейший НПЗ европейской части "
               "России). После атак 15 июля и 29–30 августа 2026 года завод "
               "пережил третий удар 14 сентября 2026 года и с этой даты "
               "находится в полной остановке, поэтому сообщения об ударах "
               "БПЛА и работе ПВО по этим объектам фиксируются с начала лета "
               "2026 года.",
    },
    "bashkortostan": {
        "slug": "raketnaya-opasnost-bashkortostan",
        "nom": "Башкортостан", "prep": "Башкортостане", "gde": "в Башкортостане",
        "region": "Республика Башкортостан", "region_prep": "Башкортостане",
        "emoji": "🚀", "volume": "н/д",
        "ctx": "В Башкортостане расположен крупный нефтеперерабатывающий узел "
               "— Уфимская группа («Башнефть-Новойл» и «Башнефть-"
               "Уфанефтехим», 24 млн т/год суммарно), работающая на ~15% "
               "мощности после серии атак, и нефтехимический комплекс "
               "«Газпром нефтехим Салават» (10 млн т/год), работающий на "
               "~30% мощности; удары БПЛА по этим предприятиям, включая "
               "подтверждённый удар по Уфимскому узлу 25 июня 2026 года, "
               "фиксируются регулярно, несмотря на удалённость региона "
               "(около 1500 км) от линии фронта.",
    },
}
...
def render(key, today):
    ...
    return TEMPLATE.format(
        ...
        region_abbr=("Р" + c["region"].split()[1][0].upper()) if c["region"].split()[0] == "Республика"
                    else c["region"].split()[0][:3].upper(),
