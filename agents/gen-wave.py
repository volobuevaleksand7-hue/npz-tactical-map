...
DISCLAIMER_TEXT = ("Данные — предварительно, по данным публичного мониторинга "
                    "radar-map.ru; это не официальная информация. Следите за "
                    "официальными оповещениями МЧС и региональных властей.")
    ...
    html.append(f"""
      <div class="landing-hero">
        ...
        <div id="waveActive" style="{active_style}">
          ...
          <p class="hero-sub">Оценка по открытому мониторингу radar-map.ru, не официальное оповещение. Обновляется автоматически.</p>
          {cover}
      ...
      <p class="lead-p">Волной мы называем всплеск одновременной активности БПЛА сразу во многих городах и регионах — по данным публичного OSINT-мониторинга radar-map.ru. Это не прогноз и не официальное оповещение, а агрегированная оценка по открытым источникам: цифры выше обновляются автоматически по мере поступления новых данных.</p>
