...
REGISTRY = {
    ...
    "surgutskij-zsk": {
        "primary_kw": "сургутский зск статус",
        "keywords": ["сургутский зск", "завод стабилизации конденсата сургут",
                     "дефицит бензина в хмао", "нпз хмао югра"],
        "note": "Сургутский ЗСК (завод стабилизации конденсата, НЕ классический НПЗ), Газпром "
                "переработка, ХМАО — Югра, 12 млн т/год, operational 100%. Ударов нет. "
                "deficit_regions: ХМАО — Югра level=low, смягчается с 23.06 — на странице явно "
                "разведено, что завод перерабатывает конденсат в нефтехимсырьё и не является "
                "прямым источником розничного бензина округа (не выдумывать причинности).",
    },
    "krasnodarskij-npz": {
        "primary_kw": "краснодарский нпз статус",
        "keywords": ["краснодарский нпз", "краснодарэконефт", "работает ли краснодарский нпз",
                     "дефицит бензина в краснодарском крае"],
        "note": "Краснодарский НПЗ (Краснодарэконефть), Роснефть, Краснодарский край, 3 млн т/год, "
                "operational 100%. Ударов по самому заводу нет — на странице явно разведено с "
                "соседями по региону, у которых удары были (ilskij-npz, afipskij-npz, "
                "tuapsinskij-npz), перелинковка на все три. deficit_regions: Краснодарский край "
                "level=low, регион восстанавливается с 10.06 (на 28.07 очереди сокращены).",
    },
    "lukojl-permnefteorgsintez": {
        "primary_kw": "лукойл-пермнефтеоргсинтез",
        "keywords": ["пермский нпз", "пермский нпз остановлен", "нпз пермь атака",
                     "работает ли пермский нпз", "дефицит бензина в пермском крае"],
        "note": "Лукойл, Пермский край, 13,1 млн т/год — один из крупнейших НПЗ РФ. fuel-state "
                "down 0% с 07.05, damage лишь «Остановлен после атаки» без деталей; в strikes.json "
                "записи о самой атаке нет (окно strikes начинается 06.06, позже даты остановки) — "
                "честно отражено как разрыв в данных, источник только сводный обзор Reuters/Liga.net. "
                "Отдельной deficit_regions-записи по Пермскому краю нет — региональный уровень не "
                "заявляется.",
    },
    "orskij-npz": {
        "primary_kw": "орский нпз",
        "keywords": ["орский нпз удар", "орский нпз бпла", "работает ли орский нпз",
                     "орский нпз форте инвест", "дефицит бензина в оренбургской области"],
        "note": "Форте Инвест, Оренбургская обл., 6,6 млн т/год. fuel-state down 0% с 06.07, удар "
                "БПЛА подтверждён в strikes.json (confidence=confirmed), до этого завод не "
                "атаковался. Дефицит — только в составе укрупнённого кластера «Урал» "
                "(Свердловская/Челябинская/Оренбургская/Тюмень/Башкирия), level=low с 22.06.",
    },
    "slavyanskij-npz": {
        "primary_kw": "славянский нпз",
        "keywords": ["славянск эко", "славянский нпз удар", "славянский нпз пожар",
                     "нпз славянск-на-кубани", "дефицит бензина в краснодарском крае"],
        "note": "Славянск ЭКО, Краснодарский край, 5 млн т/год. fuel-state partial ~35% с 28.06, "
                "единственная атака в strikes.json — пожар в ночь на 28.06 (1 погибший в городе, "
                "1 пострадавший в Трудобеликовском). Дефицит Краснодарский край level=low с 10.06, "
                "на 28.07 заметно улучшилось (источник fontanka).",
    },
    "ns-oil": {
        "primary_kw": "ns-oil",
        "keywords": ["нс-ойл новоспасское", "ns-oil удар", "новоспасское нпз бпла",
                     "ns-oil пожар", "дефицит бензина в ульяновской области"],
        "note": "Независимый/частный, рп Новоспасское Ульяновской обл., 2,8 млн т/год. fuel-state "
                "partial ~20% с 23.07 (confidence=reported), strikes.json — два удара в ночь на "
                "23.07 (газовая база + база сжиженного газа ООО «НС-Ойл», вторая волна с пожаром). "
                "Отдельной deficit_regions-записи по Ульяновской области нет — региональный уровень "
                "не заявляется.",
    },
}
